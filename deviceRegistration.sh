...
sudo chmod -R 777 ./*
cat $path/src/main/resources/com/paasmer/devicesdkjava/util/output.txt >> .Install.log
...
sed -ie s/^deviceName=.*/deviceName=$PAASMER/ $path/src/main/resources/com/paasmer/devicesdkjava/util/config.properties
sed -ie s/^clientId=.*/clientId=$PAASMER/ $path/src/main/resources/com/paasmer/devicesdkjava/util/config.properties
sed -ie s/^certificateFile=.*/certificateFile=$PAASMER-certificate.pem.crt/ $path/src/main/resources/com/paasmer/devicesdkjava/util/config.properties
sed -ie s/^privateKeyFile=.*/privateKeyFile=$PAASMER-private.pem.key/ $path/src/main/resources/com/paasmer/devicesdkjava/util/config.properties
sudo chmod 777 ./*
echo $PAASMER >> .Install.log
